...
if (isset($_POST['register_submit'])) {
    ...
    if (count($errors) == 0) {
        ...
        $sql = "INSERT INTO `user`(`Name`, `email`, `password`, `phone_no`) VALUES ('$name','$email','$password','$ph_no')";
...
if (isset($_POST['jobs_submit'])) {
    ...
    $query2 = "INSERT INTO `job`(`company_name`, `position`, `job_desc`, `skills`,`CTC`) VALUES ('$cname','$position','$job_desc','$skills','$ctc')";
    ...
    if (in_array($fileActualExt, $fileTypeAllowed)) {
        if ($fileError === 0) {
            if ($fileSize < 1000000) {
                ...
                $query3 = "INSERT INTO `candidate`(`name`, `apply`, `qualification`, `year`, `resume`) VALUES ('$name','$apply','$qualification','$year','$fileNameNew')";
